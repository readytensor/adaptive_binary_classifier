...
def check_preprocessing(
    ...
    print(
        "Transformed and balanced train X/y shapes:",
        balanced_train_inputs.shape,
        balanced_train_labels.shape,
    )
    print(
        "Balanced train data class counts:",
        Counter(balanced_train_labels.values.ravel()),
    )
    print(
        "Processed validation X/y shapes:",
        transformed_val_inputs.shape,
        transformed_val_labels.shape,
    )
