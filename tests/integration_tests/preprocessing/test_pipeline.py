...
@pytest.fixture
def pipeline(schema_provider, pipeline_config):
    """Creating a preprocessing pipeline for testing"""
    return get_preprocess_pipeline(schema_provider, pipeline_config)


def test_train_pipeline(pipeline, sample_data):
    """
...
def test_transform_inputs(pipeline, sample_data):
    """
...
def test_numerical_features_are_present(pipeline, sample_data):
    """
...
def test_one_hot_encoded_categorical_features_are_present(pipeline, sample_data):
    """
    Test if the numerical features are retained in the preprocessed data.
    """
    trained_pipeline = train_pipeline(pipeline, sample_data)
...
def test_pipeline_with_missing_values(pipeline):
    """
...
def test_pipeline_with_rare_labels(schema_provider, pipeline_config):
    ...
    This test will help you ensure that the rare label encoding step is working
    as expected.
    """
...
def test_pipeline_with_empty_dataframe(pipeline):
    """
...
def test_pipeline_with_only_numeric_features(pipeline):
    """
...
def test_pipeline_drops_all_nan_numeric_columns(schema_provider, pipeline_config):
    """
